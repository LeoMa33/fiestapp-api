...
class DeviceAuthApi {
  ...
  const DeviceAuthApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> authControllerLogin({ 
    required LoginDeviceDto loginDeviceDto,
    ...
    try {
      const _type = FullType(LoginDeviceDto);
      _bodyData = _serializers.serialize(loginDeviceDto, specifiedType: _type);
  ...
  Future<Response<User>> authControllerRegister({ 
    ...
    final _path = r'/auth/device/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
